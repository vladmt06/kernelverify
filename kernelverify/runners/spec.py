...
# as int32 and stride buffers as int64; uint32 carries packed quantized words,
# and uint16 carries bfloat16, which numpy cannot hold at all (ADR 0019) -
# kernelverify.schemas.bfloat16 owns the two conversions.
TENSOR_DTYPES = {
    "float32": np.float32,
    "float16": np.float16,
    "int32": np.int32,
