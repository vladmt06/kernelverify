...
The pure functions in this module own every scientific reading.  The
experiment-specific driver composes the shared process and provenance
machinery and may never turn a missing check into a pass.
"""
